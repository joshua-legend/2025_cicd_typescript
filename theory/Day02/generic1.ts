...
type Utility = "잔나" | "룰루" | "윾미";

type LOL<T extends Tanker | Bruiser, J extends Tanker | Bruiser | Assasin, M extends Magicion | Assasin, B extends ADC, S extends Utility | Tanker> = {
  top: T;
  jg: J;
  mid: M;
  bot: B;
