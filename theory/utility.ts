...
type 짱구인물 = "짱구" | "짱아" | "봉미선" | "신형만" | "철수" | "맹구" | "훈발" | "유리" | "채성아" | "나미리" | "이슬이 누나";
...
const topping: { topping: Topping } = { topping: "고기" };

type Vegitable = { vegitable: ("양상추" | "토마토" | "오이" | "파프리카" | "할라피뇨" | "피클")[] };
type Source = { source: ("렌치" | "스위트칠릿" | "핫칠리" | "바베큐" | "후추" | "올리브오일")[] };
...
type Test = Pick<Students, "name" | "age">;
type Test1 = Omit<Students, "major">;
